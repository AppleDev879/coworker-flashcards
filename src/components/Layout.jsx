...
export default function Layout() {
  ...
  // Check if we're on the home/deck list page
      ...
      <header className="bg-paper/80 backdrop-blur-md border-b border-cream-dark sticky top-0 z-50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 py-3 sm:py-4 flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center gap-3 group">
            <div className="w-9 h-9 bg-coral/10 rounded-lg flex items-center justify-center group-hover:bg-coral/20 transition-colors">
